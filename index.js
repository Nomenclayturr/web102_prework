...
const description = `There ${unfundedGamesCount === 1 ? "is" : "are"} ${unfundedGamesCount} unfunded game${unfundedGamesCount === 1 ? "" : "s"} out of ${GAMES_JSON.length} total. Please consider supporting these projects!`;
